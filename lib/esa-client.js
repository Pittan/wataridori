...
var fs = require('fs');
var ESA_ENDPOINT_PROTOCOL = 'https';
var ESA_ENDPOINT_DOMAIN = 'api.esa.io';
exports.ESA_API_INTERVAL = 12000;
var EsaClient = /** @class */ (function () {
    function EsaClient(teamName, token) {
     ...
     * @param params
     */
    EsaClient.prototype.upload = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var isPng, imageFileOptions, options;
            return __generator(this, function (_a) {
                isPng = params.filepath.endsWith('png');
                imageFileOptions = {
